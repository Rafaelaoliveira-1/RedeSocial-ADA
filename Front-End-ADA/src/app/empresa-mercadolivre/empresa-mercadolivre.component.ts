...
@Component({
  selector: 'app-empresa-mercadolivre',
  templateUrl: './empresa-mercadolivre.component.html',
  styleUrls: ['./empresa-mercadolivre.component.css']
})
export class EmpresaMercadolivreComponent implements OnInit {
