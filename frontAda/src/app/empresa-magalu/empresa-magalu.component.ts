...
@Component({
  selector: 'app-empresa-magalu',
  templateUrl: './empresa-magalu.component.html',
  styleUrls: ['./empresa-magalu.component.css']
})
export class EmpresaMagaluComponent implements OnInit {
